...
export interface IPlayerRightArmGUIProperties extends GUIProperties {
...
export interface IPlayerRightArmProps extends IPropsWithGUIOptions<IPlayerRightArmGUIProperties> {
...
export default class RightArm extends SceneNode<Mesh> {
	...
	constructor (props: IPlayerRightArmProps) {
